...
public class ElementsNarutomodMod implements IFuelHandler, IWorldGenerator {
	...
	public ElementsNarutomodMod() {
		...
		sounds.put(new ResourceLocation("narutomod", "sharingan_activate"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("narutomod", "sharingan_activate")));
	...
	public static class GuiHandler implements IGuiHandler {
		...
		public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
			...
			if (GuiScrollExtraJutsu.handles(id))
				return new GuiScrollExtraJutsu.GuiContainerMod(world, x, y, z, player, id);
			return null;
		}
		...
		public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
			...
			if (GuiScrollExtraJutsu.handles(id))
				return new GuiScrollExtraJutsu.GuiWindow(world, x, y, z, player, id);
			return null;
		}
	}
